...
class ComerciosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('comercios')->insert([//2
            ...
            'descripcion' => 'Nos complace darle la bienvenida a nuestro comercio e invitarle a conocer más de cerca nuestro local y nuestra excelente cocina. <br> <br> Tanto si se decanta por los platos clásicos como por las innovaciones: nuestros menús y la oferta de temporada satisfarán al paladar más exigente.',
            'prioridad' => '1',
            'categoria_id' => '1',
            'orden' => '20'
        ]);
        ...
        DB::table('comercios')->insert([//5
            ...
            'descripcion' => 'Este restaurante se ha especializado en cocina mexicana. El Chilecito te ofrece sus singulares tacos, su bien trabajado laing y sus generosos nachos. Empieza tu comida con una deliciosa cerveza. <br> <br>
        ...
        DB::table('comercios')->insert([//6
            ...
            'descripcion' => 'El AC Hotel Almería está ubicado en el corazón del centro histórico y comercial de la provincia y localidad de Almería, cerca de la Alcazaba, y permite un fácil acceso al aeropuerto, Museo Arqueológico, estación de tren, recinto ferial, playa y mar. -Paseo lateral. <br> <br> Aproveche la conexión inalámbrica a internet gratuita en todo el hotel. Nuestro hotel de 4 estrellas también cuenta con 8 salones de eventos, habitaciones para no fumadores, cajas de seguridad, instalaciones para negocios y un restaurante, "El Asador".',
            'prioridad' => '1',
            'categoria_id' => '3',
            'orden' => '60'
        ]);
        ...
        DB::table('comercios')->insert([//7
            ...
            'descripcion' => 'Los platos de sus cocinas mediterránea y española están muy bien elaborados en este bar. Te va a encantar su comida, especialmente su bien trabajado pescado, sus sabrosas tapas y su sorprendente laing. Merece la pena degustar aquí una buena cerveza o un sensacional vino. <br> <br>
        ...
        DB::table('comercios')->insert([//13
            ...
            'descripcion' => 'Este hotel sin pretensiones se encuentra en el centro de la ciudad, a 1 km de la estación de tren de Almería y de la Alcazaba, y a 5 minutos a pie de la catedral. <br> <br>

            Las habitaciones son funcionales y cuentan con Wi‑Fi gratis, minibar y televisión de pantalla plana. Las suites incluyen sofá cama. Hay servicio de habitaciones. <br> <br>
        ...
        DB::table('comercios')->insert([//15
            ...
            'descripcion' => 'Una vez que hayas disfrutado de Paseo de Almeria, visita este restaurante, que no está muy lejos. Si disfrutas de las cocinas mediterránea y española, completa tu colección en Mini Bar. Prueba sus magníficas tapas, su fascinante cerdo y sus singulares gambas. <br> <br>
        ...
        DB::table('comercios')->insert([//16
            ...
            'descripcion' => 'En este bar van a ofrecerte una carta variada basada en la cocina española. Sus sabrosas tapas, generoso entrecot y sorprendente entrecote te van a saber increíblemente bien. Muchos críticos se han dado cuenta de que aquí puedes comer con confianza un bien valorado pudin. Pide su insuperable cerveza, sus deliciosos tinto de verano o sus espectaculares tinto de verano. La limonada que podrás pedir aquí es sensacional. <br> <br>
        ...
        DB::table('comercios')->insert([//18
            ...
            'descripcion' => 'Este sofisticado hotel, con vistas al puerto de Almería, se encuentra a 11 minutos a pie de la estación de tren, a 14 de la playa del Zapillo y a 2 km de la Alcazaba. <br> <br>

            Las habitaciones y suites son funcionales y tienen Wi‑Fi gratis, televisión por satélite, balcón, minibar y, en algunos casos, vistas al mar. Las suites incluyen zona de estar independiente. Hay servicio de habitaciones. Los menores de 4 años se alojan gratis con un adulto. <br> <br>
        ...
        DB::table('comercios')->insert([//23
            ...
            'descripcion' => 'Hotel la Perla es un alojamiento familiar y acogedor situado en pleno centro de Almería, en La Puerta Purchena, junto a lugares de gran interés turístico como La Alcazaba y La Catedral. <br> <br>
            Con más de 140 años de historia, contamos con una larga trayectoria a nuestras espaldas, ofreciendo el mejor servicio y profesionalidad a nuestros clientes. <br> <br>
            Entre nuestros huéspedes contamos con muchos actores como Clint Eastwood y Lee Van Cleef y directores como Sergio Leone, protagonistas de los Spaguetti Western que se rodaban en Almería en los años 60 y 70. <br> <br>
        ...
        DB::table('comercios')->insert([//26
            ...
            'descripcion' => 'Visita este restaurante y come algo si tienes hambre tras disfrutar de Iglesia de la Virgen del Mar. Prueba algo distinto de la cocina china. Aquí sirven un tierno pollo al limón. Algunos de sus visitantes aconsejan probar la excelente limonada de China City. <br> <br>
        ...
        DB::table('comercios')->insert([//29
            ...
            'descripcion' => 'Si coincide que estás cerca de Biblioteca Publica Provincial Francisco Villaespesa, visita este café. Cafeteria Colombia sirve cocina española. La receta del éxito de este lugar está en su perfectamente elaborado laing. Empieza tu comida con un magnífico café. <br> <br>
        ...
        DB::table('comercios')->insert([//31
            ...
            'descripcion' => 'Este café te ofrece buenos platos y un lugar donde descansar tras un largo paseo alrededor de Biblioteca Publica Provincial Francisco Villaespesa.  <br> <br> Prueba sus generosas tapas para hacerte una idea de cómo es Cafetería Sagunto. Una serie de usuarios estiman que en este establecimiento el personal es atento. Su divino servicio es prueba del alto nivel de calidad de este lugar. Disfruta de su espectacular ambiente.',
            'prioridad' => '4',
            'categoria_id' => '2'
        ]);
        ...
        DB::table('comercios')->insert([//33
            ...
            'descripcion' => 'Ven a beber algo tras ese largo paseo por Biblioteca Publica Provincial Francisco Villaespesa. Clasijazz te ofrece estupendos platos de la cocina mediterránea. El laing es aquí atrayente, y eso es lo que los comensales habituales de este lugar suelen asegurar. Empieza tu comida con una sensacional cerveza. Este lugar es conocido por su magnífico café. <br> <br>
        ...
        DB::table('comercios')->insert([//34
            ...
            'descripcion' => 'Si quieres tener un buen recuerdo de Biblioteca Publica Provincial Francisco Villaespesa, ven primero a este café. <br> <br> Las cocinas mediterránea y española son buenas en Cafeteria Lubrin. Siempre puedes degustar unas caseras tapas, unos sorprendentes patatas o un generoso laing en este lugar. Su buen café hará que tu comida sea más sabrosa, lo que, seguramente, te hará volver.',
            'prioridad' => '5',
            'categoria_id' => '2'
        ]);

        DB::table('comercios')->insert([//35
            'nombre' => 'Academia Acceso',
            'ubicacion' => 'Calle Martínez Campos, 7, 04001 Almería',
            'descripcion' => 'Centro de Formación privado con más de treinta años de experiencia, academia Acceso se ha convertido en un referente para la preparación de oposiciones en Almería. <br><br>
            Especialistas en la preparación de oposiciones de Cuerpos y Fuerzas de Seguridad del Estado, Policía Nacional y Guardia Civil, Administrativo de la Junta de Andalucía, Administración de Justicia, (Cuerpos de Auxilio Judicial, Tramitación Procesal y Administrativa, Gestión Procesal y Administrativa), Técnicos de Medio Ambiente, Profesores y Directores de Formación Vial, ámbito docente cuerpo de Maestros y especialidades de Secundaria. <br>
            Ven a conocernos a nuestras instalaciones. Te esperamos. ',
            'prioridad' => '5',
            'categoria_id' => '4'
        ]);

        DB::table('comercios')->insert([//36
            'nombre' => 'Academia de Inglés Sherwood',
            'ubicacion' => 'Calle Rambla Obispo Orberá, 38, 04004 Almería',
            'descripcion' => 'En Sherwood sabemos que el tiempo es oro, y por ello os ofrecemos más horas que el resto para preparar vuestro examen oficial Cambridge, Trinity o Aptis! <br>
            Excelentes resultados nos avalan en todos ellos! <br>
            Tenemos al mejor profesorado y la mejor metodología. <br>
            Estamos en pleno centro de Almería.',
            'prioridad' => '5',
            'categoria_id' => '4'
        ]);

        DB::table('comercios')->insert([//37
            'nombre' => 'Academia Gestión',
            'ubicacion' => 'Calle Padre Juan Aguilar, 34, 04005 Almería',
            'descripcion' => 'Centro de Gestión y Administración de Empresas de Almería. Somos un centro de formación homologado por la Junta de Andalucía. Nuestra filosofía de impartir una enseñanza de calidad ha elevado el prestigio de nuestros cursos gracias a una sencilla fórmula: el mejor profesorado, unas instalaciones amplias y apropiadas, y material didáctico actualizado.',
            'prioridad' => '5',
            'categoria_id' => '4'
        ]);

        DB::table('comercios')->insert([//38
            'nombre' => 'Academia de Inglés Mati Bretones',
            'ubicacion' => 'Calle Tirso de Molina, 36, 04005 Almería',
            'descripcion' => 'Bienvenido a la Web de la Academia de Inglés Mati Bretones que lleva más de 25 años de experiencia profesional desde que empezó a dar clases en 1990. Con una amplísima formación académica y una dilatada carrera de experiencia en todos los niveles: iniciación, primaria, secundaria, bachillerato, adultos y preparación de los certificados de Cambridge. <br>
            La academia de inglés Mati Bretones se encuentra en el centro de Almería y en una localización tranquila lo que hace su acceso fácil para todos.',
            'prioridad' => '5',
            'categoria_id' => '4'
        ]);

        DB::table('comercios')->insert([//39
            'nombre' => 'Academia De Inglés Marbe',
            'ubicacion' => 'Av. de Blas Infante, 70, 04006 Almería',
            'descripcion' => 'Centro de Gestión y Administración de Empresas de Almería. Somos un centro de formación homologado por la Junta de Andalucía. Nuestra filosofía de impartir una enseñanza de calidad ha elevado el prestigio de nuestros cursos gracias a una sencilla fórmula: el mejor profesorado, unas instalaciones amplias y apropiadas, y material didáctico actualizado.',
            'prioridad' => '5',
            'categoria_id' => '4'
        ]);

        DB::table('comercios')->insert([//40
            'nombre' => 'EasyWay',
            'ubicacion' => 'Calle Minas de Gádor, nº12, 04009 Almería',
            'descripcion' => 'EASYWAY language school nace en 2012 apoyada en una trayectoria familiar de 35 años de experiencia en la enseñanza de calidad del inglés desde el nivel escolar (a partir de 4 años) hasta formación específica para adultos, profesionales y empresas, con una amplia variedad de horarios y tipos de curso a tu disposición en nuestras academias de inglés en Almería: inglés para niños e inglés para adultos: cursos de 9 meses, semi-intensivos, intensivos todos los veranos y cursos con fines específicos a nivel empresarial “in company”. <br> <br>
            Ya en su primer año recibió el Premio Master de Popularidad 2012 (Master Barometer Andalucía) por antecedentes en formación de idiomas, imagen, calidad y prestigio dentro del sector. Easyway cuenta con una metodología que ha tenido mucho éxito en la formación de numerosos alumnos almerienses tanto en inglés para niños (+4 años) como en inglés para adultos que ha ido evolucionando en los últimos años incorporando nuevas tecnologías pero sin perder su esencia. Además, contamos con dos academias de inglés en Almeríaformadas por un cuadro docente cuidadosamente seleccionado, profesores nativos  de inglés y bilingüe altamente cualificado, entendiendo que el equipo humano es la pieza clave del éxito de nuestra escuela.',
            'prioridad' => '5',
            'categoria_id' => '4'
        ]);

        DB::table('comercios')->insert([//41
            'nombre' => 'Ultramarinos Finos San Antonio',
            'ubicacion' => 'Calle Castelar, 10, 04001 Almería',
            'descripcion' => 'Tiendas Y Congelados Del Sur Sl cuenta con 14 años a sus espaldas. La compañía Tiendas Y Congelados Del Sur Sl está localizada en Calle la Rueda (pg san Rafael), 2. Su actividad CNAE se ubica dentro de 4781 - Comercio al por menor de productos alimenticios, bebidas y tabaco en puestos de venta y mercadillos. Tiendas Y Congelados Del Sur Sl tiene un modelo de sociedad Sociedad limitada.',
            'prioridad' => '6',
            'categoria_id' => '5'
        ]);

        DB::table('comercios')->insert([//42
            'nombre' => 'Asian Supermaxi',
            'ubicacion' => 'Calle Murcia, 39, 04004 Almería',
            'descripcion' => 'Empresa dedicada a la comercialización de productos derivados del cerdo ibérico, a través de Internet, con la posibilidad de ir ampliando progresivamente la gama de productos agroalimentarios disponibles, siguiendo siempre la más estricta línea de calidad de nuestros productos (vinos, aceite, queso, miel, productos ecológicos...).<br> <br>
        ...
        DB::table('comercios')->insert([//43
            'nombre' => 'Eduardo Blanes Alcaraz',
            'ubicacion' => 'Calle Rambla Obispo Orberá 28, 04001, Almería',
            'descripcion' => 'Comprar directamente y sin salir de su propia casa empieza a ser cada vez más extendida y al alcance de nuestra mano. Y nunca mejor dicho porque un ordenador personal un módem y una conexión a Internet son los únicos requisitos para que con un solo dedo podamos realizar nuestras compras de forma cómoda, rápida y sin movernos del sillón. La desventaja que tenemos los españoles es que la inmensa mayoría de los comercios virtuales se encuentran en Estados Unidos.',
            'prioridad' => '6',
            'categoria_id' => '5'
        ]);

        DB::table('comercios')->insert([//44
            'nombre' => 'Salvador Martínez López',
            'ubicacion' => 'Calle Antonio Vico 27, 04003, Almería',
            'descripcion' => 'El ambiente cálido de este lugar permite a sus invitados relajarse tras un duro día de trabajo. Se comenta que aquí el personal es exquisito. Su divino servicio demuestra el alto nivel de calidad de este bar. La mayoría de usuarios se han dado cuenta de que los precios son interesantes para lo que te dan. Su excepcional decoración te sorprenderá gratamente.',
            'prioridad' => '6',
            'categoria_id' => '5'
        ]);

        DB::table('comercios')->insert([//45
            'nombre' => 'SUPREMO',
            'ubicacion' => 'Calle Reina 29, 04002, Almería',
            'descripcion' => 'La buenísima ubicación céntrica de SUPREMO hace que llegar a él por cualquier medio sea muy sencillo. Una serie de usuarios mencionan que el servicio es aceptable. Según el punto de vista de los usuarios, sus precios son buenos. Sin duda vas a disfrutar de su agradable ambiente y su atrayente decoración.',
            'prioridad' => '6',
            'categoria_id' => '5'
        ]);

        DB::table('comercios')->insert([//46
            'nombre' => 'Comestibles y Encurtidos Danai',
            'ubicacion' => 'Av. Federico García Lorca, 146, 04005 Almería',
            'descripcion' => 'Empresa dedicada a la comercialización de productos derivados del cerdo ibérico, a través de Internet, con la posibilidad de ir ampliando progresivamente la gama de productos agroalimentarios disponibles, siguiendo siempre la más estricta línea de calidad de nuestros productos (vinos, aceite, queso, miel, productos ecológicos...). <br> <br>
        ...
        DB::table('comercios')->insert([//47
            'nombre' => 'Sensse Boutique Almería',
            'ubicacion' => 'Paseo de Almería, 34, 04001 Almería',
            'descripcion' => 'Disponemos de tiendas físicas en Almería y Marbella para que puedas comprobar la calidad de nuestros tejidos y diseños. <br> <br>
            Colección propia de marca SENSSE PARIS confeccionada principalmente con sedas italianas y tejidos de grandes diseñadores franceses.',
            'prioridad' => '7',
            'categoria_id' => '6'
        ]);

        DB::table('comercios')->insert([//48
            'nombre' => 'Suitié',
            'ubicacion' => 'Calle de las Tiendas, 36, 04003 Almería',
            'descripcion' => 'Nuestra misión es vestir a la mujer para un look actual. En Suitié podrás encontrar todo lo que necesitas para un look actual, arreglado pero informal. <br> <br>

            Nos encanta la moda, por eso te asesoraremos y ayudaremos a elegir lo que estás buscando. ¿Tienes una celebración a la vista? Ven a Suitié y encuentra tu look para boda, bautizo, puesta de bandas, y otras celebraciones. <br> <br>
            
            Visítanos en Calle de las Tiendas (Frente a Casa Puga) en Almería y descubre nuestras prendas de calidad que podrás llevarte a casa por un buen precio. Además, disponemos de firmas exclusivas, siempre elegidas de forma personal y pensando en tus necesidades, renovamos con frecuencia para que no tengas que repetir modelito y estés siempre a la última. <br> <br>
            
            Recuerda que en nuestra tienda siempre encontrarás las últimas tendencias y un trato con asesoramiento personalizado. <br>
            ¡Te esperamos en Suitié!',
            'prioridad' => '7',
            'categoria_id' => '6'
        ]);

        DB::table('comercios')->insert([//49
            'nombre' => 'Tempo',
            'ubicacion' => 'Calle Navarro Rodrigo, 26, 04001 Almería',
            'descripcion' => 'Prendas cómodas y sutiles que no querrás quitarte en todo el día!!! ....recordad que ya abrimos con el horario habitual, por las tardes hasta las 20:30h',
            'prioridad' => '7',
            'categoria_id' => '6'
        ]);

        DB::table('comercios')->insert([//50
            'nombre' => 'Dewe Almería',
            'ubicacion' => 'Paseo de Almería, 45, 04004 Almería',
            'descripcion' => 'En Dewe tienda online, encontrarás firmas de lujo y primeras marcas nacionales e internacionales como: Nike, Adidas, Polo, Reebok, Tommy Hilfiger, SikSilk y Carthartt WIP entre otras muchas. <br> <br>

            Ofrecemos las últimas tendencias en Zapatillas y Ropa Streetwear con múltiples métodos de pago y envíos 24h.',
            'prioridad' => '7',
            'categoria_id' => '6'
        ]);

        DB::table('comercios')->insert([//51
            'nombre' => 'Burbujas Moda',
            'ubicacion' => 'Av. de Cabo de Gata, 111, 04007 Almería',
            'descripcion' => 'Consúltenos sin compromiso, tenemos horario comercial y estamos abiertos al público en la dirección que especificamos en la web.',
            'prioridad' => '7',
            'categoria_id' => '6'
        ]);

        DB::table('comercios')->insert([//52
            'nombre' => 'INSIDE',
            'ubicacion' => 'Paseo de Almería, 59, 04001 Almería',
            'descripcion' => 'Calzado, prendas de vestir y accesorios con diseños urbanos en tiendas de moda joven para hombre y mujer.',
            'prioridad' => '7',
            'categoria_id' => '6'
        ]);
    }
